...
class LoginV:
    def __init__(self):
        self.tela = Tk()
        self.tela.title("Acesso às Vendas")
    ...
    def criar_componentes(self):
        Label(self.tela, text="Usuário", bg='#410d63', fg='white', font=("Arial", 10)).place(x=50, y=60)
        Label(self.tela, text="Senha", bg='#410d63', fg='white',font=("Arial", 10)).place(x=50, y=100)
    ...
    def abrir_menu(self):
        self.tela.destroy()
        try:
            subprocess.run([sys.executable, "MenuV.py"])
        except FileNotFoundError:
            messagebox.showerror("Erro", "Arquivo MenuV.py não encontrado")
