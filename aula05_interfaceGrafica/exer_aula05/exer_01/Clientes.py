...
class Clientes:
    ...
    def componentes(self):
        ...
        self.btn = Button(self.frame_cadastro, text="Cadastrar", command=self.cadastrar_cliente, bg="#B3EFD9", fg="white")
...
#     def componentes(self):
#         self.frame = Frame(self.tela, bg = "#1D936A", padx = 20, pady = 10)
#         self.frame.pack(expand = False, fill = 'both', padx = 20, pady = 20)

#         self.mostra = Frame(self.tela, bg = "#ADD7C8", padx = 20, pady = 10)
#         self.mostra.pack(expand = True, fill = 'both', padx = 20, pady = 20)

#         # Cadastro
#         self.titulo = Label(self.frame, text = "Cadastro - Clientes")
#         self.titulo.grid(row = 0, column = 0, columnspan = 2, pady = 5)

#         Label(self.frame, text = "Nome:").grid(row = 1, column = 0, pady = 5)
#         self.nome_entry = Entry(self.frame)
#         self.nome_entry.grid(row = 1, column = 1, pady = 5)

#         Label(self.frame, text = "Email:").grid(row = 2, column = 0, pady = 5)
#         self.email_entry = Entry(self.frame)
#         self.email_entry.grid(row = 2, column = 1, pady = 5)

#         Label(self.frame, text = "Telefone:").grid(row = 3, column = 0, pady = 5)
#         self.telefone_entry = Entry(self.frame)
#         self.telefone_entry.grid(row = 3, column = 1, pady = 5)

#         Label(self.frame, text = "Endereço:").grid(row = 4, column = 0, pady = 5)
#         self.endereco_entry = Entry(self.frame)
#         self.endereco_entry.grid(row = 4, column = 1, pady = 5)

#         self.btn = Button(self.frame, text = "Cadastrar", command = self.cadastrar_cliente)
#         self.btn.grid(row = 5, column = 0, columnspan = 2, pady = 10)

#         # Mostrar
#         self.titulo = Label(self.mostra, text = "Dados - Cliente")
#         self.titulo.grid(row = 0, column = 0, columnspan = 2, pady = 5)

#         self.label_nome = Label(self.mostra, text = "Nome: ", bg = "#ADD7C8")
#         self.label_nome.grid(pady = 5)

#         self.label_email = Label(self.mostra, text = "Email: ", bg = "#ADD7C8")
#         self.label_email.grid(pady = 5)

#         self.label_telefone = Label(self.mostra, text = "Telefone: ", bg = "#ADD7C8")
#         self.label_telefone.grid(pady = 5)

#         self.label_endereco = Label(self.mostra, text = "Endereco: ", bg = "#ADD7C8")
#         self.label_endereco.grid(pady = 5)

#     def cadastrar_cliente(self):
#         self._nome = self.nome_entry.get()
#         self._email = self.email_entry.get()
#         self._telefone = self.telefone_entry.get()
#         self._endereco = self.endereco_entry.get()
